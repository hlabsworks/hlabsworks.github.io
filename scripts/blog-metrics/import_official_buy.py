...
retailer_bill/derived/bill_breakdown.json から、公開しても問題ない集計値のみを抽出して
...
# --source で明示的に指定すること。
DEFAULT_SOURCE_PATH = Path.home() / "Develop" / "energy-archive" / "retailer_bill" / "derived" / "bill_breakdown.json"
