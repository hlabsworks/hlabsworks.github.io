...
_DENY_PATTERNS = [
    ...
    # 小売電気事業者名・送配電会社名・プラン名（居住地域の推定材料になるため、オーナー決定
    # 2026-09-23で公開側は「電力会社」「契約中の新電力」等の一般名詞に統一した。契約中の
    # 具体名・送配電会社名がpushされたデータに紛れ込むことを防ぐdeny）。
    re.compile(r"(?i)(東京電力|TEPCO|Japan電力|japaden|くらしプラン)"),
]
